...
const handleSubmit = () => {};
  ...
  return (
    <div className=" text-white flex min-h-screen flex-col items-center  sm:justify-center sm:pt-0">
      <a href="#">
      ...
      <button className="absolute top-0 right-0 mx-7 my-6 px-3 py-1 hover:bg-gray-500 rounded-sm" onClick={onClose}>
            <svg
        ...
        <div className="mx-5 border bg-gray-950 dark:border-b-white/50 dark:border-t-white/50 border-b-white/20 sm:border-t-white/20 shadow-[20px_0_20px_20px] shadow-slate-500/10 dark:shadow-white/20 rounded-lg border-white/20 border-l-white/20 border-r-white/20 sm:shadow-sm lg:rounded-xl lg:shadow-none">
