...
const Hcontact = () => {
  ...
  return (
    <>
      <div className={` flex justify-center max-md:flex-col mx-auto top-0 min-h-[95vh]`}>
        <form
          onSubmit={handleSubmit}
          className="w-1/2 max-md:w-full bg-white flex flex-col pt-8 md:mt-0 px-5 sm:px-10 sm:py-10"
        >
        ...
        <div className="w-1/2 px-5 sm:px-10 max-md:w-full py-10 bg-white text-black">
          ...
          ></iframe> */}
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d105781.9351333632!2d-118.29961954796346!3d34.05193839999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80c2c648d075cbd3%3A0xe155725fcb55203f!2s1st%20%2F%20Main!5e0!3m2!1sen!2sin!4v1710748465432!5m2!1sen!2sin"
           width="600"
            height="450" 
             allowfullscreen=""
              loading="lazy" 
